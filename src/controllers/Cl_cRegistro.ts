/*
  ...
  Sea el nombre, sexo y edad de varias personas. Se necesita un programa que lea estos datos
  y reporte al final la cantidad de hombres, mujeres, total y datos del mayor.
*/
